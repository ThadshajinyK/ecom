...
<div id="mainBody">
    ...
    @csrf
		...
		<div class="control-group">
			...
			<div class="controls">
                <input id="fname" type="text" placeholder="First Name" name="fname" required autocomplete autofocus>
			</div>
		 </div>
		 ...
		 <div class="control-group">
			...
			<div class="controls">
                <input id="lname" type="text" placeholder="Last Name" name="lname" required autocomplete autofocus>
			</div>
		 </div>
